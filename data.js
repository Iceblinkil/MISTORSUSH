const menuData = [
  {
    ...
    items: [
      ...
      { id: "c7", name: "Филадельфия", nameEn: "Philadelphia", price: 45, ingredients: "Рис, огурец, кремчиз, лосось сверху", ingredientsEn: "Rice, cucumber, cream cheese, salmon on top", image: "img/products/classic_rolls/Philadelphia.webp" },
      ...
      { id: "c13", name: "Зеленый дракон", nameEn: "Green Dragon", price: 60, ingredients: "Рис, огурец, кремчиз, лосось сверху, авокадо, терияки, кунжут", ingredientsEn: "Rice, cucumber, cream cheese, salmon on top, covered with avocado, teriyaki sauce, sesame", image: "img/products/classic_rolls/Green_Dragon.webp" },
